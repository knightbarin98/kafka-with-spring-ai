...
public class OpenAIService implements AIService {
  ...
  public OpenAIService(AIGeneratedTweetToKafkaServiceConfigData configData,
  ...
  public String generateTweet() throws AIGeneratedTweetToKafkaServiceException {
    ...
    try(CloseableHttpClient httpClient = HttpClients.createDefault()){
      ...
      throw new AIGeneratedTweetToKafkaServiceException("Failed generate response OpenAI", e);
    }
  }
